...
export function FinalCTA({ onNavigate }: FinalCTAProps) {
  ...
  return (
    <section className="py-16 md:py-24 text-white relative overflow-hidden" aria-labelledby="final-cta-title" style={{ background: 'var(--brand-secondary)' }}>
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <header className="mb-12">
            <h2 id="final-cta-title" className="text-3xl md:text-4xl lg:text-5xl mb-6">
              {title}
            </h2>
