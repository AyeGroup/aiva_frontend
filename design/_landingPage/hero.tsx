...
export function Hero({ onNavigate }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pattern-dots opacity-20" style={{ backgroundColor: '#F1FAF8' }}></div>
      
      {/* Sharp Floating Elements */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 opacity-15" style={{
        background: 'var(--sharp-secondary)',
        borderRadius: '50%',
        filter: 'blur(60px)'
      }}></div>
      
      <div className="absolute bottom-1/3 left-1/5 w-64 h-64 opacity-12" style={{
        background: 'var(--sharp-emerald)',
        borderRadius: '50%',
        filter: 'blur(40px)'
      }}></div>
      
      <div className="absolute top-1/2 left-1/2 w-48 h-48 opacity-8" style={{
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center min-h-[80vh]">
          ...
          <div className="space-y-10 text-right">
            ...
            <div className="inline-flex items-center gap-3 glass-effect px-6 py-3 rounded-full shadow-sm">
              <div className="w-2 h-2 rounded-full" style={{ background: 'var(--sharp-cyan)' }}></div>
              <span className="text-sm font-medium" style={{ color: '#65bcb6' }}>جدیدترین فناوری هوش مصنوعی</span>
            </div>
            ...
            <header className="space-y-8">
              ...
              >
                <span className="text-sharp-secondary font-semibold">{headline}</span>
              </h1>
              <p 
            ...
            {/* Sharp Social Proof */}
            <div className="glass-effect rounded-2xl p-6 border-2" style={{ borderColor: 'var(--sharp-primary)' }}>
              <div className="flex flex-wrap items-center gap-8">
                <div className="flex items-center gap-3 text-sm text-grey-600">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--sharp-cyan)' }}></div>
                  <span className="font-medium">بیش از ۱۰۰۰ کسب‌وکار فعال</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-grey-600">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--sharp-orange)' }}></div>
                  <span className="font-medium">راه‌اندازی در کمتر از ۵ دقیقه</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-grey-600">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--sharp-emerald)' }}></div>
          ...
          <div className="relative" id="demo">
            {/* Sharp Floating Elements */}
            <div className="absolute -top-6 -right-6 w-24 h-24 rounded-full morphing-shape" style={{ 
              background: 'var(--sharp-pink)', 
              opacity: 0.15 
            }}></div>
            <div className="absolute -bottom-4 -left-4 w-16 h-16 rounded-full floating-element" style={{ 
              background: 'var(--sharp-teal)', 
              opacity: 0.2 
            }}></div>
            <div className="absolute top-1/2 right-1/4 w-8 h-8 rounded-full particle-effect" style={{ 
              background: 'var(--sharp-violet)', 
              opacity: 0.25 
            }}></div>
            <div className="absolute top-1/4 left-1/3 w-12 h-12 rounded-full" style={{ 
