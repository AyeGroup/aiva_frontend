...
import { MessageSquare, Users, Star, CheckCircle2, TrendingUp, TrendingDown } from 'lucide-react';
  ...
  return (
    <Card className="p-6 hover:shadow-md transition-all duration-200 cursor-pointer group">
      <div className="flex items-start justify-between mb-4">
        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${getIconColor()} group-hover:scale-110 transition-transform`}>
