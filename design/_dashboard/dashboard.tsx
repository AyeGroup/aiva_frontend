...
import { DashboardCard } from '../_components/DashboardCard/dashboard-card';
import { StatCard } from '../_components/StatCard/stat-card';
import { ChannelCard } from '../_components/ChannelCard/channel-card';
import { PerformerCard } from '../_components/PerformerCard/performer-card';
import { ActivityChart } from '../_components/ActivityChart/activity-chart';
import { ColorShowcase } from '../_components/ColorShowcase/color-showcase';
import { HeatmapChart } from '../_components/HeatmapChart/heatmap-chart';
...
export function Dashboard({ onNavigate }: DashboardProps) {
  ...
  const chartColor = chartType === 'users' ? 'var(--brand-primary)' : 'var(--brand-secondary)';
          ...
          <div className="max-w-7xl mx-auto pb-8">
            ...
            <div className="mb-8">
              ...
              <div className="stats-hero-section bg-[#E3F4F1] p-8 rounded-3xl border-2 border-white/50 shadow-xl backdrop-blur-sm mb-8">
                <div className="flex items-center justify-between mb-8">
                  <h2 className="text-2xl font-bold text-grey-900 text-[20px]">📊 آمار کلیدی امروز</h2>
                  <p className="text-[rgba(166,166,166,1)] text-[14px]">نگاهی سریع به عملکرد چت‌بات در ۲۴ ساعت گذشته</p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  ...
                  <div className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:rotate-1">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <div className="text-[24px] font-black text-grey-900 mb-1 group-hover:text-brand-primary transition-colors text-center">{convertToPersian('245K')}</div>
                      <div className="text-[14px] font-medium text-center leading-tight" style={{ color: '#A6A6A6' }}>کاربران فعال</div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-rotate-1">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <div className="text-[24px] font-black text-grey-900 mb-1 group-hover:text-brand-secondary transition-colors text-center">{convertToPersian('12.8K')}</div>
                      <div className="text-[14px] font-medium text-center leading-tight" style={{ color: '#A6A6A6' }}>گفتگوهای امروز</div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:rotate-1">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <div className="text-[24px] font-black text-grey-900 mb-1 group-hover:text-brand-accent transition-colors text-center">{convertToPersian('4.2')}</div>
                      <div className="text-[14px] font-medium text-center leading-tight" style={{ color: '#A6A6A6' }}>دقیقه متوسط گفتگو</div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-rotate-1">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <div className="text-[24px] font-black text-grey-900 mb-1 group-hover:text-brand-emerald transition-colors text-center">{convertToPersian('1.2s')}</div>
                      <div className="text-[14px] font-medium text-center leading-tight" style={{ color: '#A6A6A6' }}>زمان پاسخ متوسط</div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:rotate-1">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <div className="text-[24px] font-black text-grey-900 mb-1 group-hover:text-success transition-colors text-center">{convertToPersian('94%')}</div>
                      <div className="text-[14px] font-medium text-center leading-tight" style={{ color: '#A6A6A6' }}>نرخ رضایت کاربران</div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-rotate-1">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <div className="text-[24px] font-black text-grey-900 mb-1 group-hover:text-brand-purple transition-colors text-center">{convertToPersian('18')}</div>
                      <div className="text-[14px] font-medium text-center leading-tight" style={{ color: '#A6A6A6' }}>پیام در هر گفتگو</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2 px-[12px] py-[0px]">
                      <p className="text-body-small text-[rgba(166,166,166,1)] text-[14px]">
                        {chartType === 'users' ? 'تعداد کاربران فعال در هر روز' : 'تعداد گفتگوهای انجام شده در هر روز'}
                      </p>
                    </div>
                  </div>
                  <ActivityChart 
            ...
            <div className="relative mb-8">
              ...
              <div className="flex justify-end mb-4 ml-auto w-fit">
                <div className="text-right">
                  <h3 className="font-bold text-grey-900 mb-1">فعال ترین کاربران</h3>
                </div>
              </div>
              
              {/* Active Users Container */}
              <div className="glass-effect rounded-[var(--radius-card)] p-6 mt-" style={{ 
                background: '#FEF9F6',
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 p-[0px] mt-[12px] mr-[0px] mb-[0px] ml-[0px]">
                  ...
                  <div className="relative bg-white rounded-lg p-4 pt-8 text-center shadow-sm hover-lift">
                    <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full flex items-center justify-center shadow-md text-white font-bold" style={{
                      background: '#e19f87'
                    }}>
                      م
                    </div>
                    <h4 className="font-bold text-grey-900 mb-2 mt-2">محمد احمدی</h4>
                  ...
                  <div className="relative bg-white rounded-lg p-4 pt-8 text-center shadow-sm hover-lift">
                    ...
                    <h4 className="font-bold text-grey-900 mb-2 mt-2">زهرا کریمی</h4>
                  ...
                  <div className="relative bg-white rounded-lg p-4 pt-8 text-center shadow-sm hover-lift">
                    ...
                    <h4 className="font-bold text-grey-900 mb-2 mt-2">علی رضایی</h4>
                  ...
                  <div className="relative bg-white rounded-lg p-4 pt-8 text-center shadow-sm hover-lift">
                    ...
                    <h4 className="font-bold text-grey-900 mb-2 mt-2">فاطمه حسینی</h4>
                    <p className="text-2xl font-semibold text-grey-900">۷۲</p>
                    <p className="text-body-small text-grey-500">گفتگو</p>
                  </div>

                  {/* More Users Button */}
                  <div className="relative rounded-lg p-4 shadow-sm hover-lift cursor-pointer flex items-center justify-center" style={{
                    background: '#FF8970',
                    border: '1px solid #FF8970'
                  }}>
                    <div className="flex items-center justify-center gap-2">
                      <h4 className="font-bold text-[14px] text-[rgba(255,255,255,1)]">مشاهده همه</h4>
                ...
                <div className="bg-white rounded-lg p-6 shadow-card">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="w-8 h-8 bg-bg-soft-mint rounded-full flex items-center justify-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-brand-primary">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-brand-primary font-medium">{convertToPersian('245')} کلیک</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-grey-600">راهنمای خرید</span>
                      <span className="text-brand-primary font-medium">{convertToPersian('184')} کلیک</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-grey-600">پشتیبانی</span>
                      <span className="text-brand-primary font-medium">{convertToPersian('142')} کلیک</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-grey-600">قیمت گذاری</span>
                      <span className="text-brand-primary font-medium">{convertToPersian('98')} کلیک</span>
                    </div>
                  </div>
                </div>
                <UpgradeBanner />
