...
import { Plus, Settings, FileText, BarChart3, Users, MessageSquare } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {actions.map((action) => {
          ...
          return (
            ...
            >
              <div className={`w-12 h-12 rounded-lg ${colorClasses} border-2 mb-3 flex items-center justify-center group-hover:scale-110 transition-transform`}>
