  ...
  const handleKeyDown = (e: React.KeyboardEvent, itemId: string) => {
    switch (e.key) {
      ...
      case 'ArrowDown':
        ...
        const nextButton = document.getElementById(`accordion-trigger-${items[nextIndex].id}`);
        nextButton?.focus();
        break;
      case 'ArrowUp':
        e.preventDefault();
        ...
        const prevButton = document.getElementById(`accordion-trigger-${items[prevIndex].id}`);
        prevButton?.focus();
        break;
    }
  };
