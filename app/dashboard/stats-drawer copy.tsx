            ...
            <div className="plans-compact">
              ...
              <div className="plan-compact-card">
                <div className="plan-compact-header">
                  <div
                    ...
                    style={{ background: "var(--bg-soft-peach)" }}
                  >
                    <Zap
                      size={16}
                ...
                <ul className="plan-compact-features">
                  <li>{"5,000"} پیام در ماه</li>
                  <li>سه چت‌بات فعال</li>
                  <li>پشتیبانی اولویت‌دار</li>
                  <li>گزارش‌گیری پایه</li>
                </ul>
                <button className="plan-compact-button text-center">
                  انتخاب پلن
                </button>
              </div>
              ...
              <div className="plan-compact-card featured">
                ...
                <div className="plan-compact-header">
                  <div
                    className="plan-compact-icon"
                    style={{ background: "var(--bg-soft-mint)" }}
                  >
                    <Crown
                      size={16}
                  ...
                  <div>
                    ...
                    <p className="plan-compact-price">
                      {/* {plans.professional[billingPeriod]} */}
                       تومان
                    </p>
                  </div>
                </div>
                <ul className="plan-compact-features">
                  <li>{"20,000"} پیام در ماه</li>
                  <li>ده چت‌بات فعال</li>
                  <li>پشتیبانی ۲۴/۷</li>
                  <li>گزارش‌گیری پیشرفته</li>
                </ul>
                <button className="plan-compact-button primary text-center">
                  انتخاب پلن
                </button>
              </div>
              ...
              <div className="plan-compact-card">
                <div className="plan-compact-header">
                  <div
                    className="plan-compact-icon"
                    style={{ background: "var(--bg-soft-lavender)" }}
                  >
                  ...
                  <div>
                    ...
                    <p className="plan-compact-price">
                      {/* {plans.advanced[billingPeriod]} */}
                       تومان
                    </p>
                  </div>
                </div>
                <ul className="plan-compact-features">
                  <li>{"100,000"} پیام در ماه</li>
