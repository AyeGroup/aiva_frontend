  ...
  const [tickets, setTickets] = useState<Ticket[]>([
    {
      ...
      description:
        "چت‌بات در صفحه اصلی وب‌سایت نمایش داده نمی‌شود و کاربران نمی‌توانند با آن تعامل برقرار کنند. مشکل از دیروز شروع شده است.",
      status: "open",
      priority: "high",
      category: "technical",
      createdAt: "۱۴۰۳/۰۹/۱۵",
      updatedAt: "۱۴۰۳/۰۹/۱۶ - ۱۴:۳۰",
      assignee: "تیم فنی",
      replies: [
        {
          id: "r1",
          ...
          role: "user",
          message:
            "چت‌بات در صفحه اصلی وب‌سایت نمایش داده نمی‌شود و کاربران نمی‌توانند با آن تعامل برقرار کنند.",
        ...
        },
        {
          ...
          role: "support",
          message:
            "سلام، در حال بررسی مشکل هستیم. لطفاً کد جاوا اسکریپت نصب شده در سایت خود را بررسی کنید.",
          timestamp: "۱۴۰۳/۰۹/۱۵ - ۱۶:۱۵",
        },
      ],
    },
    {
      ...
      description:
        "آیا امکان تغییر پلن در وسط ماه وجود دارد؟ همچنین آیا تخفیف سالانه برای پلن‌های بالاتر در نظر گرفته شده است؟",
      status: "pending",
      priority: "medium",
      category: "billing",
      createdAt: "۱۴۰۳/۰۹/۱۴",
      updatedAt: "۱۴۰۳/۰۹/۱۵ - ۱۶:۱۵",
      assignee: "تیم فروش",
    },
    {
      id: "TKT-2024-003",
      title: "درخواست ویژگی جدید - پشتیبانی از فایل‌های صوتی",
      description:
        "امکان اضافه کردن فایل صوتی به پاسخ‌های چت‌بات و همچنین دریافت پیام‌های صوتی از کاربران.",
      status: "closed",
      priority: "low",
      category: "general",
      createdAt: "۱۴۰۳/۰۹/۱۰",
      updatedAt: "۱۴۰۳/۰۹/۱۲ - ۰۹:۴۵",
      assignee: "تیم توسعه",
    },
    {
      id: "TKT-2024-004",
      title: "بهینه‌سازی سرعت پاسخ‌دهی چت‌بات",
      description:
        "گاهی اوقات چت‌بات با تأخیر پاسخ می‌دهد. آیا امکان بهبود سرعت وجود دارد؟",
      status: "pending",
      priority: "medium",
      category: "technical",
      createdAt: "۱۴۰۳/۰۹/۱۳",
      updatedAt: "۱۴۰۳/۰۹/۱۴ - ۱۱:۲۰",
      assignee: "تیم فنی",
    },
  ]);
