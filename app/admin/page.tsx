      ...
      <main className="flex-1 p-6 lg:px-12 overflow-y-auto h-screen ">
        ...
        <div className="w-full z-0! stats-hero-section bg-[#E3F4F1] p-8 rounded-3xl border-2 border-white/50 shadow-xl backdrop-blur-sm mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div
              className={`group bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105  overflow-hidden relative`}
            >
              <div
            ...
            <div className="group bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 overflow-hidden relative">
              <div
