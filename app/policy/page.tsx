...
const Policy = () => (
  <section className=" mx-auto px-4 py-10 lg:p-30 leading-8 text-gray-800">
    ...
    <p className="mb-8 text-justify">
      ...
      شرایط و قوانین زیر است.
     
       لطفاً پیش از استفاده از سرویس‌ها، این صفحه را با
      دقت مطالعه کنید.
    </p>

    <h2 className="text-xl font-semibold mt-10 mb-3 text-gray-900">۱. تعاریف</h2>
    ...
    <h2 className="text-xl font-semibold mt-10 mb-3 text-gray-900">۸. قطع خدمات</h2>
    <ul className="list-disc pr-6 space-y-2 text-justify">
      <li>مشکلات فنی</li>
