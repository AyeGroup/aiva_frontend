      ...
      <div className="max-w-7xl mx-auto px-6">
              ...
              >
                ...
                <article 
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 12px 28px -8px rgba(239, 68, 68, 0.25)';
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-white" style={{ fontSize: '0.75rem', fontWeight: '600' }}>مشکل</span>
                  </div>
                  ...
                  <div className="flex items-start gap-5 mt-3">
                    ...
                    <div className="flex-1 text-right">
                      ...
                      <p className="text-grey-600" style={{ fontSize: '0.938rem' }}>
                ...
                <article 
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = 'translateY(-4px)';
                    e.currentTarget.style.boxShadow = '0 12px 28px -8px rgba(16, 185, 129, 0.25)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.boxShadow = '0 1px 3px rgba(0, 0, 0, 0.05)';
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-white" style={{ fontSize: '0.75rem', fontWeight: '600' }}>راه‌حل</span>
                  </div>
        ...
        <div className="text-center mt-20">
          <div 
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = '0 10px 30px -5px rgba(101, 188, 182, 0.2)';
            ...
            <div className="flex items-start gap-3 text-right">
              ...
              <div className="flex-1">
                <p className="text-grey-800 mb-1">
                  <strong>نکته:</strong> با آیوا، تیم پشتیبانی شما روی مشکلات پیچیده تمرکز می‌کنه
                </p>
