      ...
      <div className="max-w-7xl mx-auto px-6">
        <header className="text-center mb-16">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 bg-[#E3F4F1]">
            ...
            <span className="text-sm text-[#65bcb6]" style={{ fontWeight: '500' }}>داستان‌های موفقیت</span>
          </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {activeCase.stats.map((stat, index) => {
              const isPositive = stat.value.includes('+') || stat.value.includes('٪') || stat.value.includes('/');
              const isNegative = stat.value.includes('-');
              
              const colors = [
                { light: 'rgba(16, 185, 129, 0.1)', dark: '#10B981', border: 'rgba(16, 185, 129, 0.2)' },
                { light: 'rgba(59, 130, 246, 0.1)', dark: '#3B82F6', border: 'rgba(59, 130, 246, 0.2)' },
                { light: 'rgba(239, 68, 68, 0.1)', dark: '#EF4444', border: 'rgba(239, 68, 68, 0.2)' }
              ];
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    >
                      {isPositive && !isNegative && (
                        <TrendingUp className="w-4 h-4" style={{ color: color.dark }} aria-label="روند صعودی" />
                      )}
                      {isNegative && (
                        <TrendingDown className="w-4 h-4" style={{ color: color.dark }} aria-label="روند نزولی" />
                      )}
                    </div>
                  </div>
                  ...
                  <div className="mb-3">
                    <p 
                      ...
                      style={{ fontSize: '2.5rem', fontWeight: '700', lineHeight: '1', letterSpacing: '-0.02em' }}
                    >
                      {stat.value}
                    </p>
                  </div>
                  ...
                  {/* Label */}
                  <h4 className="text-grey-800 mb-2">
                    {stat.label}
                  </h4>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex-1 text-center md:text-right">
                <blockquote className="mb-4">
                  <p className="text-grey-700 leading-relaxed" style={{ fontSize: '1.125rem' }}>
                ...
                <footer>
                  <cite className="not-italic">
                    ...
                    <p className="text-grey-500" style={{ fontSize: '0.875rem' }}>
