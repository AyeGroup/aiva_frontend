...
function Text() {
  return (
    <div className="absolute h-[20px] left-[16px] top-[8px] w-[112.797px]" data-name="Text">
      <p className="absolute  font-medium leading-[20px] left-[56.5px] text-[#65bcb6] text-[14px] text-center text-nowrap top-0 translate-x-[-50%] whitespace-pre" dir="auto">
        داستان‌های موفقیت
      </p>
    </div>
  );
...
function Heading2() {
  return (
    ...
    >
      <p className="absolute  font-extrabold leading-[57.6px] left-[615.84px] text-[48px] text-center text-gray-900 text-nowrap top-[-1px] tracking-[-0.96px] translate-x-[-50%] whitespace-pre" dir="auto">
    ...
    return (
      ...
      >
        ...
        <div className="absolute h-[22.5px] left-0 top-[12.75px]">
          <p className=" font-semibold leading-[22.5px] text-[15px] text-gray-800 text-nowrap">Amazon</p>
        </div>
        <motion.div 
  ...
  if (isActive) {
    return (
      ...
      >
        ...
        <div className="absolute h-[22.5px] left-0 top-[12.75px]">
          <p className=" font-semibold leading-[22.5px] text-[15px] text-gray-800 text-nowrap">Adidas</p>
        </div>
        <motion.div 
  ...
  if (isActive) {
    return (
      ...
      >
        ...
        <div className="absolute h-[22.5px] left-0 top-[12.75px]">
          <p className=" font-semibold leading-[22.5px] text-[15px] text-gray-800 text-nowrap">Microsoft</p>
        </div>
        <motion.div 
  ...
  if (isActive) {
    return (
      ...
      >
        ...
        <div className="absolute h-[22.5px] left-0 top-[12.75px]">
          <p className=" font-semibold leading-[22.5px] text-[15px] text-gray-800 text-nowrap">Zara</p>
        </div>
        <motion.div 
  ...
  if (isActive) {
    return (
      ...
      >
        ...
        <div className="absolute h-[22.5px] left-0 top-[12.75px]">
          <p className=" font-semibold leading-[22.5px] text-[15px] text-gray-800 text-nowrap">Starbucks</p>
        </div>
        <motion.div 
  ...
  if (isActive) {
    return (
      ...
      >
        ...
        <div className="absolute h-[22.5px] left-0 top-[12.75px]">
          <p className=" font-semibold leading-[22.5px] text-[15px] text-gray-800 text-nowrap">Apple</p>
        </div>
        <motion.div 
...
function TabNike({ isActive, onClick }: { isActive?: boolean; onClick?: () => void }) {
  return (
    ...
    >
      ...
      <div className="absolute h-[22.5px] left-0 top-[12.75px]">
        <p className=" font-semibold leading-[22.5px] text-[15px] text-gray-800 text-nowrap">Nike</p>
      </div>
      {isActive && (
        <motion.div 
    ...
    >
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[549px] py-0 relative w-full">
          <p className=" font-medium leading-[30px] relative shrink-0 text-[22px] text-center text-gray-900 text-nowrap whitespace-pre" dir="auto">
    ...
    >
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[518px] py-0 relative w-full">
          <p className=" font-medium leading-[26px] relative shrink-0 text-[16px] text-center text-gray-500 text-nowrap whitespace-pre" dir="auto">
            {category}
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[40px] left-[26px] top-[70px] w-[316px]" data-name="Paragraph">
        <p className="absolute  font-bold leading-[40px] left-0 text-[40px] text-gray-900 text-nowrap top-[-0.5px] tracking-[-0.8px] whitespace-pre" dir="auto">
          {value}
        </p>
      </div>
      <div className="absolute content-stretch flex h-[28px] items-start left-[26px] top-[122px] w-[316px]" data-name="Heading 4">
        <p className="basis-0  font-medium grow leading-[28px] min-h-px min-w-px relative shrink-0 text-[18px] text-gray-900" dir="auto">
          {title}
        </p>
      </div>
      <div className="absolute h-[26px] left-[26px] top-[158px] w-[316px]" data-name="Paragraph">
        <p className="absolute  font-medium leading-[26px] left-0 text-[14px] text-gray-600 text-nowrap top-0 whitespace-pre" dir="auto">
          {description}
        </p>
      </div>
    </motion.div>
...
function Paragraph8({ text }: { text: string }) {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-end relative shrink-0 w-full" data-name="Paragraph">
      <p className=" font-medium leading-[29.25px] relative shrink-0 text-[18px] text-gray-700 text-right w-[700px]" dir="auto">{`"${text}"`}</p>
    </div>
  );
}
...
function Paragraph9({ name }: { name: string }) {
  return (
    <div className="h-[26px] relative shrink-0 w-[645px]" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[645px] text-[16px] text-gray-900 text-nowrap text-right top-0 translate-x-[-100%] whitespace-pre" dir="auto">
        {name}
      </p>
    </div>
  );
...
function Paragraph10({ role, company }: { role: string; company: string }) {
  return (
    <div className="h-[26px] relative shrink-0 w-[645px]" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[645px] text-[14px] text-gray-500 text-right top-0 translate-x-[-100%] w-[220px]" dir="auto">
        {role} • {company}
      </p>
    </div>
  );
