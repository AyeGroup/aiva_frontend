...
function Icon6() {
  return (
    <div
      className="absolute h-[1069.64px] left-0 top-0 w-[1431px]"
      data-name="Icon"
    >
      <svg
        className="block size-full"
...
function Icon7() {
  return (
    <div
      className="absolute h-[192px] left-0 top-[877.64px] w-[1431px]"
      data-name="Icon"
    >
      <svg
        className="block size-full"
...
function Container() {
  return (
    <div
      className="absolute h-[1069.64px] left-0 overflow-clip top-0 w-[1431px]"
      data-name="Container"
    >
      <Icon />
      <Icon1 />
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center rounded-3xl bg-[rgba(101,188,182,0.08)] border border-[rgba(101,188,182,0.15)] py-2 px-3 mx-auto">
        ...
        <span className="text-primary"> داستان‌های موفقیت</span>
      </div>
      <p className="font-extrabold text-center text-2xl text-gray-900">
        کسب‌وکارهایی که با آیوا اتوماسیون و رشد را تجربه کردند
      </p>
      <p className="text-center text-gray-600">نتایج واقعی از برندهای مختلف</p>
    </motion.div>
  );
}
    ...
    return (
      ...
      >
        ...
        <div className="absolute h-[22.5px] left-0 top-[12.75px]">
          <p className=" font-semibold leading-[22.5px] text-[15px] text-gray-800 text-nowrap">
            Amazon
          </p>
        </div>
        <motion.div
    ...
    return (
      ...
      >
        <div className="absolute bg-[#65bcb6] content-stretch flex items-center justify-center left-[79.922px] rounded-[1.67772e+07px] size-[48px] top-0">
          <svg className="size-[28px]" fill="none" viewBox="0 0 28 28">
            <path
              d={navSvgPaths.p1fa66600}
              stroke="white"
              strokeWidth="2.33333"
            />
            <path d={navSvgPaths.p1835bb70} fill="white" />
            <path
              d={navSvgPaths.p38a2f6f0}
              stroke="white"
              strokeLinecap="round"
              strokeWidth="1.75"
            />
            <path
              d={navSvgPaths.p21e85058}
              stroke="white"
              strokeLinecap="round"
              strokeWidth="1.75"
            />
...
function TabNike({
  ...
  return (
    ...
    >
      <div
        className={`absolute ${
          isActive ? "bg-[#65bcb6]" : "bg-gray-100"
        } content-stretch flex items-center justify-center left-[42.35px] rounded-[1.67772e+07px] size-[48px] top-0 transition-colors duration-300`}
      >
        <svg className="size-[28px]" fill="none" viewBox="0 0 28 28">
          <path
            d={navSvgPaths.p3982a5f0}
            fill={isActive ? "white" : "#65BCB6"}
          />
        </svg>
      </div>
      <div className="absolute h-[22.5px] left-0 top-[12.75px]">
...
function Navigation({
  ...
  return (
    <motion.div
      className="content-stretch flex gap-6 items-center my-12 justify-center relative shrink-0"
    ...
    >
      <TabAmazon
        isActive={activeBrand === "amazon"}
        onClick={() => setActiveBrand("amazon")}
      />
      <TabAdidas
        isActive={activeBrand === "adidas"}
        onClick={() => setActiveBrand("adidas")}
      />
      <TabMicrosoft
        isActive={activeBrand === "microsoft"}
        onClick={() => setActiveBrand("microsoft")}
      />
      <TabZara
        isActive={activeBrand === "zara"}
        onClick={() => setActiveBrand("zara")}
      />
      <TabStarbucks
        isActive={activeBrand === "starbucks"}
        onClick={() => setActiveBrand("starbucks")}
      />
      <TabApple
    ...
    >
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[549px] py-0 relative w-full">
          <p
            className=" font-medium leading-[30px] relative shrink-0 text-[22px] text-center text-gray-900 text-nowrap whitespace-pre"
            dir="auto"
          >
    ...
    >
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[518px] py-0 relative w-full">
          <p
            className=" font-medium leading-[26px] relative shrink-0 text-[16px] text-center text-gray-500 text-nowrap whitespace-pre"
            dir="auto"
          >
            {category}
          </p>
...
function Container4({ brand }: { brand: string }) {
  ...
  return (
    <div
      className="content-stretch flex flex-col gap-[4px] h-[60px] items-center justify-center relative shrink-0 w-full"
      data-name="Container"
    >
...
function Container5() {
  return (
    <div
      className="absolute bg-[rgba(239,68,68,0.1)] box-border content-stretch flex flex-col h-[28px] items-start left-[302px] pb-0 pt-[6px] px-[12px] rounded-[1.67772e+07px] top-[26px] w-[40px]"
      data-name="Container"
    >
      <Icon8 />
    </div>
...
function Article({
  ...
  return (
    ...
    >
      {badge}
      <div
        className="absolute h-[40px] left-[26px] top-[70px] w-[316px]"
        data-name="Paragraph"
      >
        <p
          className="absolute  font-bold leading-[40px] left-0 text-[40px] text-gray-900 text-nowrap top-[-0.5px] tracking-[-0.8px] whitespace-pre"
          dir="auto"
        >
          {value}
        </p>
      ...
      <div
        className="absolute content-stretch flex h-[28px] items-start left-[26px] top-[122px] w-[316px]"
        data-name="Heading 4"
      >
        <p
          className="basis-0  font-medium grow leading-[28px] min-h-px min-w-px relative shrink-0 text-[18px] text-gray-900"
          dir="auto"
        >
          {title}
        </p>
      ...
      <div
        className="absolute h-[26px] left-[26px] top-[158px] w-[316px]"
        data-name="Paragraph"
      >
        <p
          className="absolute  font-medium leading-[26px] left-0 text-[14px] text-gray-600 text-nowrap top-0 whitespace-pre"
          dir="auto"
        >
          {description}
        </p>
...
function Icon9() {
  return (
    ...
    >
      <div
        className="absolute inset-[45.83%_8.33%_29.17%_66.67%]"
        data-name="Vector"
      >
        <div className="absolute inset-[-16.667%]">
          <svg
...
function Container6() {
  return (
    <div
      className="absolute bg-[rgba(59,130,246,0.1)] box-border content-stretch flex flex-col h-[28px] items-start left-[302px] pb-0 pt-[6px] px-[12px] rounded-[1.67772e+07px] top-[26px] w-[40px]"
      data-name="Container"
    >
      <Icon9 />
    </div>
...
function Container7() {
  return (
    <div
      className="absolute bg-[rgba(16,185,129,0.1)] box-border content-stretch flex flex-col h-[28px] items-start left-[302px] pb-0 pt-[6px] px-[12px] rounded-[1.67772e+07px] top-[26px] w-[40px]"
      data-name="Container"
    >
      <Icon10 />
    </div>
...
function Container8({ brand }: { brand: string }) {
    ...
    nike: [
      {
        badge: (
          <div
            aria-hidden="true"
            className="absolute border-2 border-[rgba(239,68,68,0.2)] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.05)]"
          />
        ),
      ...
      },
      {
        badge: (
          <div
            aria-hidden="true"
            className="absolute border-2 border-[rgba(59,130,246,0.2)] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.05)]"
          />
        ),
      ...
      },
      {
        badge: (
          <div
            aria-hidden="true"
            className="absolute border-2 border-[rgba(16,185,129,0.2)] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.05)]"
          />
        ),
  ...
  return (
    <div
      className="content-stretch flex gap-[20px] h-[210px] items-start relative shrink-0 w-full"
      data-name="Container"
    >
  ...
  return (
    ...
    >
      ...
      >
        <g id="222222 1">
          <path
            d={svgPaths.p23b59480}
            fill="var(--fill-0, #C4D7D4)"
            id="Vector"
          />
          <path
            d={svgPaths.p12d62480}
            fill="var(--fill-0, #B2C9C6)"
            id="Vector_2"
          />
          <path
            d={svgPaths.pac21f80}
            fill="var(--fill-0, #CFD3A3)"
            id="Vector_3"
          />
          <path
            d={svgPaths.p4bc0d80}
            fill="var(--fill-0, #C4C695)"
            id="Vector_4"
          />
          <path
            d={svgPaths.p7f96f00}
          ...
          />
          <path
            d={svgPaths.p18b39f00}
            fill="var(--fill-0, #C4C695)"
            id="Vector_6"
          />
          <path
            d={svgPaths.p123ac280}
            fill="var(--fill-0, #C4C695)"
            id="Vector_7"
          />
          <path
            d={svgPaths.p3d279a80}
            fill="var(--fill-0, #C4C695)"
            id="Vector_8"
          />
          <path
            d={svgPaths.p212c8ef0}
            fill="var(--fill-0, #C4D7D4)"
            id="Vector_9"
          />
          <path
            d={svgPaths.p114bc100}
            fill="var(--fill-0, #CFD3A3)"
            id="Vector_10"
          />
          <path
            d={svgPaths.p18b49f00}
            fill="var(--fill-0, #C4C695)"
            id="Vector_11"
          />
          <path
            d={svgPaths.p2d285400}
            fill="var(--fill-0, #B2C9C6)"
            id="Vector_12"
          />
          <path
            d={svgPaths.p2d79d280}
            fill="var(--fill-0, #A9C6D3)"
            id="Vector_13"
          />
          <path
            d={svgPaths.p38f73500}
            fill="var(--fill-0, #93B5C1)"
            id="Vector_14"
          />
          <path
            d={svgPaths.paef5300}
            fill="var(--fill-0, #A1BAB0)"
            id="Vector_15"
          />
          <path
            d={svgPaths.p36524580}
            fill="var(--fill-0, #93B5C1)"
            id="Vector_16"
          />
          <path
            d={svgPaths.p3f0afc40}
            fill="var(--fill-0, #A9C6D3)"
            id="Vector_17"
          />
          <path
            d={svgPaths.p35984c00}
            fill="var(--fill-0, #93B5C1)"
            id="Vector_18"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p12af61f2}
            fill="var(--fill-0, #93B5C1)"
            id="Vector_20"
          />
          <path
            d={svgPaths.p2be9d100}
            fill="var(--fill-0, #93B5C1)"
            id="Vector_21"
          />
          <path
            d={svgPaths.p36c22b80}
            fill="var(--fill-0, #B2C9C6)"
            id="Vector_22"
          />
          <path
            d={svgPaths.p116d4600}
            fill="var(--fill-0, #F7B686)"
            id="Vector_23"
          />
          <path
            d={svgPaths.p13836600}
            fill="var(--fill-0, #69A1C4)"
            id="Vector_24"
          />
          <path
            d={svgPaths.p38d42c80}
            fill="var(--fill-0, #69A1C4)"
            id="Vector_25"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p2c6c2670}
            fill="var(--fill-0, #56335B)"
            id="Vector_27"
          />
          <path
            d={svgPaths.p22b2a00}
          ...
          />
          <path
            d={svgPaths.p1a397bc0}
            fill="var(--fill-0, #2F1A31)"
            id="Vector_29"
          />
          <path
            d={svgPaths.p9694280}
            fill="var(--fill-0, #060633)"
            id="Vector_30"
          />
          <path
            d={svgPaths.p2eb1b500}
            fill="var(--fill-0, #060633)"
            id="Vector_31"
          />
          <path
            d={svgPaths.p16721bc0}
            fill="var(--fill-0, #060633)"
            id="Vector_32"
          />
          <path
            d={svgPaths.p1784cc00}
            fill="var(--fill-0, #060633)"
            id="Vector_33"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p34314d00}
            fill="var(--fill-0, #F7B686)"
            id="Vector_35"
          />
          <path
            d={svgPaths.p2f960680}
            fill="var(--fill-0, #56335B)"
            id="Vector_36"
          />
          <path
            d={svgPaths.p31479500}
            fill="var(--fill-0, white)"
            id="Vector_37"
          />
          <path
            d={svgPaths.p1beb8e00}
            fill="var(--fill-0, #2F1A31)"
            id="Vector_38"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p249ce500}
            fill="var(--fill-0, #F7B686)"
            id="Vector_41"
          />
          <path
            d={svgPaths.p254a1500}
            fill="var(--fill-0, #F7B686)"
            id="Vector_42"
          />
          <path
            d={svgPaths.p19b81180}
            fill="var(--fill-0, #F7B686)"
            id="Vector_43"
          />
          <path
            d={svgPaths.p39c94c80}
            fill="var(--fill-0, #F7B686)"
            id="Vector_44"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p2db06680}
            fill="var(--fill-0, #FFA18E)"
            id="Vector_51"
          />
          <path
            d={svgPaths.p1d1cfc80}
            fill="var(--fill-0, #2F1A31)"
            id="Vector_52"
          />
          <path
            d={svgPaths.p2521b500}
            fill="var(--fill-0, #F7B686)"
            id="Vector_53"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p3a957a80}
            fill="var(--fill-0, #FFA18E)"
            id="Vector_55"
          />
          <path
            d={svgPaths.p1f36ce00}
            fill="var(--fill-0, #FFA18E)"
            id="Vector_56"
          />
          <path
            d={svgPaths.p13084900}
            fill="var(--fill-0, #F7B686)"
            id="Vector_57"
          />
          <path
            d={svgPaths.p19090700}
            fill="var(--fill-0, #FFA18E)"
            id="Vector_58"
          />
          <motion.path
          ...
          />
          <path
            d={svgPaths.p1ce2c600}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_62"
          />
          <path
            d={svgPaths.p1c7a03f0}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_63"
          />
          <path
            d={svgPaths.p1db4d600}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_64"
          />
          <path
            d={svgPaths.p208a7fc0}
            fill="var(--fill-0, #79A39B)"
            id="Vector_65"
          />
          <path
            d={svgPaths.p1dfe5600}
            fill="var(--fill-0, #79A39B)"
            id="Vector_66"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p3a452c00}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_68"
          />
          <path
            d={svgPaths.p388961f0}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_69"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p1638c980}
            fill="var(--fill-0, #65BCB6)"
            id="Vector_71"
          />
          <path
            d={svgPaths.p11f20d00}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_72"
          />
          <path
            d={svgPaths.p2771b480}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_73"
          />
          <path
            d={svgPaths.p325cac00}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_74"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p214e6e00}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_76"
          />
          <path
            d={svgPaths.p29c98a00}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_77"
          />
          <path
            d={svgPaths.p36494980}
            fill="var(--fill-0, #79A39B)"
            id="Vector_78"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p19d87b00}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_80"
          />
          <path
            d={svgPaths.p30ceda00}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_81"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p1d630600}
            fill="var(--fill-0, #EDF9F7)"
            id="Vector_83"
          />
          <path
            d={svgPaths.p2ba62e00}
            fill="var(--fill-0, #2F1A31)"
            id="Vector_84"
          />
          <path
            d={svgPaths.p2dfcd640}
            fill="var(--fill-0, #FFA18E)"
            id="Vector_85"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p26e2d800}
            fill="var(--fill-0, #2F1A31)"
            id="Vector_87"
          />
          <path
            d={svgPaths.p3605ed00}
            fill="var(--fill-0, #FFA18E)"
            id="Vector_88"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p2aec8e80}
            fill="var(--fill-0, #2F1A31)"
            id="Vector_90"
          />
          <path
            d={svgPaths.p144a4b00}
            fill="var(--fill-0, #65BCB6)"
            id="Vector_91"
          />
          <path
            d={svgPaths.p1d573980}
            fill="var(--fill-0, white)"
            id="Vector_92"
          />
          <path
            d={svgPaths.pfc136f0}
            fill="var(--fill-0, #F9D780)"
            id="Vector_93"
          />
          <path
            d={svgPaths.p3625fe80}
            fill="var(--fill-0, #F9D780)"
            id="Vector_94"
          />
          <path
            d={svgPaths.p1f852340}
            fill="var(--fill-0, #F9D780)"
            id="Vector_95"
          />
          <path
            d={svgPaths.p1145b200}
            fill="var(--fill-0, #81B3CC)"
            id="Vector_96"
          />
          <path
            d={svgPaths.p2df7f900}
            fill="var(--fill-0, #FCC67E)"
            id="Vector_97"
          />
          <path
            d={svgPaths.p3c0ada00}
            fill="var(--fill-0, #81B3CC)"
            id="Vector_98"
          />
          <path
            d={svgPaths.p339fbb00}
            fill="var(--fill-0, #FCC67E)"
            id="Vector_99"
          />
        </g>
...
function Paragraph8({ text }: { text: string }) {
  return (
    ...
    >
      <p
        className=" font-medium leading-[29.25px] relative shrink-0 text-[18px] text-gray-700 text-right w-[700px]"
        dir="auto"
      >{`"${text}"`}</p>
    </div>
  );
...
function Paragraph9({ name }: { name: string }) {
  return (
    <div className="h-[26px] relative shrink-0 w-[645px]" data-name="Paragraph">
      <p
        className="absolute  font-medium leading-[26px] left-[645px] text-[16px] text-gray-900 text-nowrap text-right top-0 translate-x-[-100%] whitespace-pre"
        dir="auto"
      >
        {name}
      </p>
...
function Paragraph10({ role, company }: { role: string; company: string }) {
  return (
    <div className="h-[26px] relative shrink-0 w-[645px]" data-name="Paragraph">
      <p
        className="absolute  font-medium leading-[26px] left-[645px] text-[14px] text-gray-500 text-right top-0 translate-x-[-100%] w-[220px]"
        dir="auto"
      >
        {role} • {company}
      </p>
...
function Container9({
  ...
  return (
    <div
      className="basis-0 content-stretch flex flex-col grow h-full items-end justify-center min-h-px min-w-px relative shrink-0"
      data-name="Container"
    >
      <Quote quote={quote} />
...
function Image({ src }: { src: string }) {
  return (
    <div
      className="h-[74px] relative shrink-0 w-full"
      data-name="Image (عکس رضا محمدی)"
    >
      <img
        alt=""
...
function Container10({ brand }: { brand: string }) {
  const brandImages: Record<string, string> = {
    // nike: imgImage,
    amazon:
      "https://images.unsplash.com/photo-1675663351050-89949e051c38?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmZW1hbGUlMjBleGVjdXRpdmUlMjBwb3J0cmFpdHxlbnwxfHx8fDE3NjI1NDM3OTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    adidas:
      "https://images.unsplash.com/photo-1651684215020-f7a5b6610f23?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWxlJTIwcHJvZmVzc2lvbmFsJTIwaGVhZHNob3R8ZW58MXx8fHwxNzYyNTEwNDU3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    microsoft:
      "https://images.unsplash.com/photo-1560250097-0b93528c311a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMG1hbiUyMHBvcnRyYWl0fGVufDF8fHx8MTc2MjQ0NjE1MHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    starbucks:
      "https://images.unsplash.com/photo-1629507208649-70919ca33793?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMHByb2Zlc3Npb25hbCUyMHBvcnRyYWl0fGVufDF8fHx8MTc2MjQ5OTMyMnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    apple:
      "https://images.unsplash.com/photo-1752859951149-7d3fc700a7ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWNoJTIwcHJvZmVzc2lvbmFsJTIwcG9ydHJhaXR8ZW58MXx8fHwxNzYyNDU2Mzg3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  };

  return (
    <div
      className="relative rounded-[1.67772e+07px] shrink-0 size-[80px]"
      data-name="Container"
    >
      ...
      <div
        aria-hidden="true"
        className="absolute border-[#65bcb6] border-[3px] border-solid inset-0 pointer-events-none rounded-[1.67772e+07px]"
      />
    </div>
  );
}
...
function Container11({
  ...
  return (
    <div
      className="basis-0 content-stretch flex gap-[24px] grow items-center justify-end min-h-px min-w-px relative shrink-0 w-full"
      data-name="Container"
    >
...
function Container12({
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-200 border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.05)]"
      />
      <Container11
        quote={quote}
        name={name}
...
function TabPanel({ brand }: { brand: string }) {
  ...
  > = {
    ...
    zara: {
      quote:
        "مشتریان ما حالا می‌تو��ند با کمک آیوا ست‌های لباس مناسب پیدا کنن و راهنمایی سایز دریافت کنن. فروش به شکل چشمگیری افزایش یافت.",
      name: "نگار امینی",
  ...
  return (
    <div
      className="content-stretch flex flex-col gap-[48px] h-[621px] items-center relative shrink-0 w-full"
      data-name="Tab Panel"
    >
...
export default function Section5() {
  ...
  return (
    <div className="bg-linear-to-b from-[#f9fafb] relative w-full py-12 px-20  to-[#ffffff]">
      <Container />
