...
function Text() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0" data-name="Text">
      <p className=" font-medium leading-[20px] relative shrink-0 text-[#65bcb6] text-[14px] text-center text-nowrap whitespace-pre" dir="auto">
        ویژگی های آیوا
      </p>
    </div>
  );
...
function Heading2() {
  return (
    <div className="h-[57.594px] relative shrink-0 w-[1232px]" data-name="Heading 2">
      <p className="absolute  font-extrabold leading-[57.6px] left-[616.71px] text-[48px] text-center text-gray-900 text-nowrap top-[-1px] tracking-[-0.96px] translate-x-[-50%] whitespace-pre" dir="auto">
...
function Paragraph() {
  return (
    <div className="content-stretch flex h-[28.797px] items-start relative shrink-0 w-[768px]" data-name="Paragraph">
      <p className="basis-0  font-normal grow leading-[28.8px] min-h-px min-w-px relative shrink-0 text-[18px] text-center text-gray-600" dir="auto">
...
function Heading3() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute  font-medium leading-[30px] left-[452.13px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
        پاسخ فوری
      </p>
    </div>
  );
...
function Paragraph1() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.84px] text-[15.008px] text-gray-600 text-right top-[-1px] translate-x-[-100%] w-[219px]" dir="auto">
...
function Heading5() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute  font-medium leading-[30px] left-[452.9px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
        پاسخ یکنواخت و دقیق
      </p>
    </div>
  );
...
function Paragraph3() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.59px] text-[15.008px] text-gray-600 text-nowrap text-right top-[-1px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function Paragraph4() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.02px] text-[15.008px] text-gray-600 text-right top-[-1px] translate-x-[-100%] w-[297px]" dir="auto">
...
function Heading7() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute  font-medium leading-[30px] left-[452.44px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
        هزینه ثابت و کم
      </p>
    </div>
  );
...
function Paragraph5() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.28px] text-[15.008px] text-gray-600 text-nowrap text-right top-[-1px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function Heading8() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute  font-medium leading-[30px] left-[452.21px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
        هزینه بالای پرسنل
      </p>
    </div>
  );
...
function Paragraph6() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.74px] text-[15.008px] text-gray-600 text-right top-[-1px] translate-x-[-100%] w-[298px]" dir="auto">
...
function Heading9() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute  font-medium leading-[30px] left-[452.6px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
        بدون هزینه اضافی
      </p>
    </div>
  );
...
function Paragraph7() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.3px] text-[15.008px] text-gray-600 text-nowrap text-right top-[-1px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function Heading10() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute  font-medium leading-[30px] left-[452.73px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function Paragraph8() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.94px] text-[15.008px] text-gray-600 text-nowrap text-right top-[-1px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function Heading11() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute  font-medium leading-[30px] left-[452.7px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
        همیشه آماده
      </p>
    </div>
  );
...
function Paragraph9() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.88px] text-[15.008px] text-gray-600 text-right top-[-1px] translate-x-[-100%] w-[240px]" dir="auto">
...
function Heading12() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute  font-medium leading-[30px] left-[452.17px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
        خستگی و استرس
      </p>
    </div>
  );
...
function Paragraph10() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[452.96px] text-[15.008px] text-gray-600 text-nowrap text-right top-[-1px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function BoldText() {
  return (
    <div className="absolute content-stretch flex h-[25px] items-start left-[373.98px] top-[0.5px] w-[32.297px]" data-name="Bold Text">
      <p className=" font-bold leading-[26px] relative shrink-0 text-[16px] text-gray-900 text-nowrap text-right whitespace-pre" dir="auto">
        نکته:
      </p>
    </div>
  );
...
function Paragraph11() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <BoldText />
      <p className="absolute  font-medium leading-[26px] left-[374px] text-[16px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre" dir="auto">
...
function Paragraph12() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute  font-medium leading-[26px] left-[406.91px] text-[14px] text-gray-600 text-nowrap text-right top-0 translate-x-[-100%] whitespace-pre" dir="auto">
  ...
  return (
    <div className="h-[30px] relative shrink-0 w-[20px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[30px] relative w-[20px]">
        <p className="absolute  font-normal leading-[30px] left-[20px] text-[20px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">💡</p>
      </div>
    </div>
  );
}
