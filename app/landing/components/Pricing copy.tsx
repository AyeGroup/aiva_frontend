...
function Text() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="f] font-medium leading-[20px] relative shrink-0 text-[#65bcb6] text-[14px] text-center text-nowrap whitespace-pre">{`پلن های خرید `}</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div
      ...
      data-name="Heading 2"
    >
      <p className="absolute f] font-extrabold leading-[57.6px] left-[616.05px] text-[48px] text-center text-gray-900 text-nowrap top-[-1px] tracking-[-0.96px] translate-x-[-50%] whitespace-pre">
...
function Paragraph() {
  return (
    <div
      ...
      data-name="Paragraph"
    >
      <p className="basis-0 f] font-normal grow leading-[28.8px] min-h-px min-w-px relative shrink-0 text-[18px] text-center text-gray-600">
...
function Text1() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="f] font-medium leading-[18px] relative shrink-0 text-[12px] text-nowrap text-right text-white whitespace-pre">
        ⭐ محبوب‌ترین
      </p>
    </div>
  );
...
function Heading3() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute f] font-medium leading-[30px] left-[358.67px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        متوسط
      </p>
    </div>
  );
  ...
  return (
    ...
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-full relative w-[31.125px]">
        <p className="absolute f] font-normal leading-[21px] left-[32px] text-[14px] text-gray-500 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
          تومان
        </p>
      </div>
    </div>
  ...
  return (
    <div className="h-[18px] relative shrink-0 w-[31.125px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[18px] relative w-[31.125px]">
        <p className="absolute f] font-normal leading-[18px] left-[31.82px] text-[12px] text-gray-400 text-right top-[-0.5px] translate-x-[-100%] w-[24px]">
          / ماه
        </p>
      </div>
    </div>
...
function Text5() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.36px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[106px]">
        ۳۰۰۰ پیام ماهانه
      </p>
    </div>
  );
...
function Text6() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.8px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        تعیین رفتار چت‌بات
      </p>
    </div>
  );
...
function Text7() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.21px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        کدنگاری عمومی
      </p>
    </div>
  );
...
function Text8() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.02px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[238px]">
...
function Text9() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.8px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[95px]">
        آپلود تا ۵۰ فایل
      </p>
    </div>
  );
...
function Text10() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.33px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        آنالیتیکس پیشرفته
      </p>
    </div>
  );
...
function Text11() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.9px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        یکپار همگی
      </p>
    </div>
  );
...
function Text12() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="f] font-normal leading-[28px] relative shrink-0 text-[18px] text-nowrap text-white whitespace-pre">
...
function Card() {
  return (
    <div className="bg-white h-[713px] relative rounded-3xl shrink-0 ">
      <div className="  overflow-clip relative rounded-[inherit] ">
        {/* <div
...
function Heading4() {
  return (
    <div
      ...
      data-name="Heading 3"
    >
      <p className="absolute f] font-medium leading-[30px] left-[359.23px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        پایه
      </p>
    </div>
  );
...
function Text16() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.28px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[100px]">
        ۱۰۰۰ پیام ماهانه
      </p>
    </div>
  );
...
function Text17() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.72px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
...
function Text18() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.11px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[260px]">
...
function Text19() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.78px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
...
function Text20() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.01px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        آمار پایه
      </p>
    </div>
  );
...
function Text21() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.71px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[213px]">
...
function Text22() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="f] font-normal leading-[28px] relative shrink-0 text-[#65bcb6] text-[18px] text-nowrap whitespace-pre">
        ارتقاء به پایه
      </p>
    </div>
  );
...
function Heading5() {
  return (
    <div
      ...
      data-name="Heading 3"
    >
      <p className="absolute f] font-medium leading-[30px] left-[358.73px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        آغازین
      </p>
    </div>
  );
...
function Paragraph3() {
  return (
    <div
      ...
      data-name="Paragraph"
    >
      <p className="absolute f] font-medium leading-[26px] left-[359.31px] text-[14px] text-gray-500 text-nowrap text-right top-0 translate-x-[-100%] whitespace-pre">
        رایگان
      </p>
    </div>
  );
...
function Text26() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.96px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[91px]">
        ۵۰ پیام ماهانه
      </p>
    </div>
  );
...
function Text27() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.55px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
...
function Text28() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.91px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[128px]">
...
function Text29() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.25px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        منابع دانش پیشرفته
      </p>
    </div>
  );
...
function Heading6() {
  return (
    <div
      ...
      data-name="Heading 3"
    >
      <p className="absolute f] font-medium leading-[30px] left-[358.98px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        شخصی سازی
      </p>
    </div>
  );
...
function Text31() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="Text">
      <p className="absolute f] font-semibold leading-[36px] left-[95px] text-[36px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        توافقی
      </p>
    </div>
  );
...
function Text32() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.95px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
...
function Text33() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.16px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[281px]">
...
function Text34() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.17px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
...
function Text35() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.63px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[208px]">
...
function Text37() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.27px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
...
function Heading7() {
  return (
    <div
      ...
      data-name="Heading 3"
    >
      <p className="absolute f] font-medium leading-[30px] left-[359.1px] text-[22px] text-gray-900 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        پیشرفته
      </p>
    </div>
  );
...
function Text42() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.53px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[107px]">
        ۱۰۰۰۰ پیام ماهانه
      </p>
    </div>
  );
...
function Text43() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.26px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[206px]">
...
function Text44() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.45px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[232px]">
...
function Text45() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.02px] text-[16px] text-gray-700 text-right top-[-0.5px] translate-x-[-100%] w-[93px]">
        اتصال به CRM
      </p>
    </div>
  );
...
function Text48() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[294.87px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
        کنترل نقش کاربران
      </p>
    </div>
  );
...
function Text49() {
  return (
    <div
      ...
      data-name="Text"
    >
      <p className="absolute f] font-normal leading-[24px] left-[295.37px] text-[16px] text-gray-700 text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">
...
export default function Pricing10() {
  return (
    <div className="relative size-full">
      <div className="box-border content-stretch flex flex-col items-start p-16 relative size-full">
        <div className="box-border content-stretch flex flex-col gap-16 items-start px-6 py-0 relative size-full">
          <Header />
          <div className="content-center grid grid-cols-3 gap-6 items-center justify-end relative shrink-0 w-full">
            <Card />
            <Card1 />
            <Card2 />
            <Card3 />
