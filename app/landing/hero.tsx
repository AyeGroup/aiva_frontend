  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <svg
          className="absolute top-20 right-[10%] w-24 h-24 text-[#65bcb6] opacity-10"
          viewBox="0 0 100 100"
        >
        ...
        <svg
          className="absolute top-40 right-[25%] w-16 h-16 text-[#FFA18E] opacity-10"
          viewBox="0 0 100 100"
        >
          <rect
            x="10"
        ...
        <svg
          className="absolute bottom-32 left-[15%] w-20 h-20 text-[#b07cc6] opacity-10"
          viewBox="0 0 100 100"
        >
          <polygon points="50,10 90,90 10,90" fill="currentColor">
            <animate
              attributeName="points"
              values="50,10 90,90 10,90;50,15 90,85 10,85;50,10 90,90 10,90"
              dur="5s"
              repeatCount="indefinite"
            />
          </polygon>
        ...
        >
          ...
          >
            <animate
              attributeName="d"
              values="M0,200 Q150,100 300,200 T600,200;M0,200 Q150,300 300,200 T600,200;M0,200 Q150,100 300,200 T600,200"
              dur="8s"
              repeatCount="indefinite"
            />
          </path>
          ...
          >
            <animate
              attributeName="d"
              values="M0,250 Q150,150 300,250 T600,250;M0,250 Q150,350 300,250 T600,250;M0,250 Q150,150 300,250 T600,250"
              dur="10s"
              repeatCount="indefinite"
            />
          </path>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 text-right relative">
            ...
            <div className="inline-flex items-center gap-2 bg-[#E3F4F1] px-4 py-2 rounded-full relative">
              ...
              <span
                className="text-sm"
                style={{ color: "#65bcb6", fontWeight: "500" }}
              >
          ...
          <div className="relative">
            ...
            {/* Floating SVG Icons */}
            <svg
              className="absolute -top-6 -right-6 w-12 h-12 text-[#65bcb6] opacity-20"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
            ...
            <svg
              className="absolute -bottom-4 -left-4 w-10 h-10 text-[#FFA18E] opacity-20"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
